...
import 'package:shipcheap/requests/checkout.request.dart';
import 'package:shipcheap/requests/package.request.dart';
import 'package:shipcheap/requests/payment_method.request.dart';
import 'package:shipcheap/requests/vendor.request.dart';
...
import 'package:shipcheap/services/validator.service.dart';
import 'package:shipcheap/view_models/payment.view_model.dart';
import 'package:jiffy/jiffy.dart';
import 'package:velocity_x/velocity_x.dart';
import 'package:shipcheap/translations/checkout.i18n.dart';
  ...
  applyCoupon() async {
    ...
    try {
      ...
      if (coupon.percentage == 1) {
        packageCheckout.discount =
            (coupon.discount / 100) * packageCheckout.subTotal;
      } else {
